...
class TravellerForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'age': forms.NumberInput(attrs={'class': 'form-control', 'id': 'age', 'min': 1, 'max': 120, 'placeholder': _('Write age...'), }),
            ...
            'id_number': forms.TextInput(attrs={'class': 'form-control', 'id': 'id_number', 'placeholder': _('Write passport number...'), }),
            ...
            'point_of_entry': forms.Select(attrs={'class': 'form-control', 'id': 'point_of_entry', }),
            'name_of_transport': forms.TextInput(attrs={'class': 'form-control', 'id': 'name_of_transport', 'placeholder': _('Write Vessel/Flight/Vehicle Name...'), }),
            'seat_number': forms.TextInput(attrs={'class': 'form-control', 'id': 'seat_number', 'placeholder': _('Write your seat number...'), }),
