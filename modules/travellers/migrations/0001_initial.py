    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Ground crossing', 'Ground crossing'), ('Dry port', 'Dry port'), ('Airport', 'Airport'), ('Lakeport', 'Lakeport'), ('Seaport', 'Seaport'), ('Railway', 'Railway')], max_length=100, null=True)),
                ('agents', models.ManyToManyField(blank=True, related_name='agents', to=settings.AUTH_USER_MODEL)),
            ],
            options={
